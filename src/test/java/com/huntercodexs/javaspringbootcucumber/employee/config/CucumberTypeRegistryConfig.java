package com.huntercodexs.javaspringbootcucumber.employee.config;
...
@Configurable
public class CucumberTypeRegistryConfig implements TypeRegistryConfigurer {

    private final ObjectMapper mapper;

    public CucumberTypeRegistryConfig() {
